                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="fa fa-file-text"></i>Produk<br><small> Laporan Data Produk</small>
                                </h1>
                            </div>
                        </div>
                        <ul class="breadcrumb breadcrumb-top">
                            <li><i class="fa fa-dashboard"></i>&nbsp; Dashboard</li>
                            <li><a href="javascript:void(0)"><i class="fa fa-file-text"></i>&nbsp; Laporan Produk</a></li>
                        </ul>
                        ...
                        <div class="block full">                            
                            <div class="block-title">
                                <div class="block-options">
                                    <h2 class="pull-right"><strong><a href="<?=base_URL()?>pengguna/laporanproduk" data-toggle="tooltip" title="Refresh" class="btn btn-xs btn-default"><i class="fa fa-refresh"></i></a></strong></h2>
                                </div>
                            </div>

                            <!-- Normal Form Content -->
                            <div class="form-group form-actions">
                                <a onclick="window.open('<?=base_URL()?>pengguna/laporanproduk/lihat', 'newwindow', 'width=1300, height=650', 'resizable=yes');" class="btn btn-sm btn-info"><i class="fa fa-eye"></i>&nbsp; <span>Lihat</span></a>
